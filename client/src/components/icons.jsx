...
export function IconImage(props) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.6" {...props}>
      ...
      <path d="M21 16l-5.5-5.5a2 2 0 00-2.8 0L3 20" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconVolume(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" {...props}>
      ...
      <path d="M16.5 12a4.5 4.5 0 00-2-3.74v7.48A4.5 4.5 0 0016.5 12z" />
      <path d="M14.5 4.5v2.06A7.98 7.98 0 0119 12a7.98 7.98 0 01-4.5 7.44v2.06A9.98 9.98 0 0021 12a9.98 9.98 0 00-6.5-9.5z" />
    </svg>
  );
}
...
export function IconVolumeMute(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" {...props}>
      <path d="M4 9v6h4l5 5V4L8 9H4z" />
      <path d="M15.5 9.5l4 4m0-4l-4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
export function IconShuffle(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 6h3.5c2 0 3 1 4.5 3M3 18h3.5c2 0 3-1 4.5-3" />
      <path d="M14.5 6c1.5 2 2.5 3 4.5 3h2M14.5 18c1.5-2 2.5-3 4.5-3h2" />
...
export function IconQueue(props) {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" {...props}>
      ...
      <path d="M18 9v10m0 0l-3-3m3 3l3-3" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconSun(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" {...props}>
...
export function IconHelp(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M9.5 9.2a2.5 2.5 0 014.9.8c0 1.7-2.4 1.8-2.4 3.5" />
...
export function IconHistory(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3.5 12a8.5 8.5 0 108.5-8.5A8.47 8.47 0 006 6.5" />
      <path d="M3 3v4h4" />
